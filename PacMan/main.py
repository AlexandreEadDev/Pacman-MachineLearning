...
from PacMan.sprites import LifeSprites, MazeSprites
...
class GameController(object):
    ...
    maze_path = os.path.join("PacMan", "assets", "maze1.txt")
    ...
    def startGame(self):
        ...
        self.mazesprites = MazeSprites(
            os.path.join("PacMan", "assets", self.mazedata.obj.name + ".txt"),
            os.path.join("PacMan", "assets", self.mazedata.obj.name + "_rotation.txt"),
        )
        self.setBackground()
